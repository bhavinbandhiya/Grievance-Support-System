<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPageView.master" AutoEventWireup="true" CodeFile="GRI_Grievance_Administrator_Status.aspx.cs" Inherits="AdminPanel_GRI_Grievance_Administrator_Status" %>
    ...
    <div class="portlet light">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-green-sharp bold uppercase">Update Status</span>
            </div>
            <div class="tools">
          ...
          <div role="form">
              ...
              <div class="form-actions">
                  <div class="row">
                      <div class="col-md-9">
                          <asp:Button ID="btnSearch" SkinID="btnGreen" runat="server" Text="Update" />
