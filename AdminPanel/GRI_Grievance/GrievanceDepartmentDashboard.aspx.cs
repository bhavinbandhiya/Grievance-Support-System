...
public partial class AdminPanel_GrievanceDepartmentDashboard : System.Web.UI.Page
{
    ...
    private void Search(int PageNo)
    {
        ...
        SqlString GrievanceStatus = SqlString.Null;
        ...
        if (ddlGrievanceStatus.SelectedIndex > 0)
            GrievanceStatus = Convert.ToString(ddlGrievanceStatus.SelectedValue);
        ...
        int TotalRecords = 0;
        DataTable dt = balGrievanceSystemDetails.SelectForDepartmentDashboard(Offset, PageRecordSize, out TotalRecords, FromDate,ToDate,UserID, GrievanceStatus);
    ...
    {
        ddlGrievanceStatus.SelectedIndex = 0;
