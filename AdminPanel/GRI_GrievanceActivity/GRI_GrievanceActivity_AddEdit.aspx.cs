...
public partial class AdminPanel_GRI_GrievanceActivity_AddEdit : System.Web.UI.Page
{
    #region 10.0 Local Variables

    String FormName = "GRI_GrievanceActivity_AddEdit";
    ...
    private void FillControls()
    {
        if (Request.QueryString["GrievanceSystemID"] != null)
        {
            ...
            GRI_GrievanceActivityBAL balGrievanceSystemDetails = new GRI_GrievanceActivityBAL();
			GRI_GrievanceActivityENT entGrievanceSystemDetails = new GRI_GrievanceActivityENT();
            //entGrievanceSystemDetails = balGrievanceSystemDetails.SelectPK(CommonFunctions.DecryptBase64Int32(Request.QueryString["GrievanceSystemID"]));
