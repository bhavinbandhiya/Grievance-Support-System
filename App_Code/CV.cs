...
namespace GrievanceSystem
{
    public class CV
    {
        ...
        public static System.Data.SqlTypes.SqlDateTime GetGrievanceSystemDate = DateTime.Now;
       ...
       #region Page Header in AddEdit cs Code
        ...
        public static string DefaultDateFormatFWithDayName = "dd-MM-yyyy dddd";
        ...
        public static string DefaultHomeURL = "~/AdminPanel/GrievanceSystemDetailsList.aspx";
