...
namespace GrievanceSystem
{
    public class CommonFunctions
    {
        ...
        public static string GetStatusLabelCssForProfitLoss(decimal ProfitLoss)
        {
            string cssclass = string.Empty;

            if (Convert.ToDecimal(ProfitLoss) > 0)
            {
                cssclass = CSSClass.StatusLabelSuccess;
            }
            else
        ...
        public static string GetStatusLabelCssForRiskReward(String RiskReward)
        {
            string cssclass = string.Empty;
            if (RiskReward != string.Empty)
            {
                string[] parts = RiskReward.Split(':');
        ...
        public static string FindDropDownTextFromValue(DropDownList ddl, string value)
        {
            if (value != string.Empty)
                return ddl.Items.FindByValue(value).Text;
            return null;
        }
        public static string FindDropDownTextFromValueForEmotionOnly(string value)
        {
            Dictionary<string, string> dropdownItems = new Dictionary<string, string>()
            {
                { "1", "Anxiety" },
                { "2", "Excitement" },
                { "3", "Euphoria" },
            ...
            // Check if the value exists in the dictionary, and return the corresponding text
            if (dropdownItems.ContainsKey(value))
            {
        ...
        {
            return HttpContext.Current.Request.Url.GetLeftPart(UriPartial.Authority) + GrievanceSystem.CV.AppendForMenu;
        }
        ...
        public static String GetCssClassForDueDate(String Status)
        {
            String CssClass = String.Empty;
        ...
        public static DateTime GetGrievanceSystemDateTime()
        {
